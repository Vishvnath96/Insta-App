...
public class Constants {
    ...
    /** API Key */
    public static final String API_KEY = "a060f4c4-c47c-4a21-a3e4-f188e44598a3"; // Use your API Key when API rate limit exceeded
    ...
    public static final int ENTERTAINMENT = 9;
